    ...
    def parse(self, response):
        ...
        for t in range(len(a_href_all)):
            ...
            yield scrapy.Request(url=company_url,
                                 headers={
                                     'Referer': ' http://jzjg.gzjs.gov.cn:8088/gzzhxt/SYGS/SYGSGL/SWRQQYGSlist_new.aspx'},
        ...
        print(page, 'MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM')
        self.index = self.index + 1
        if not self.index == page:
