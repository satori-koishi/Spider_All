...
class ShanxiJianzhuImformationSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        # for t in a_href_all:
        #     print(t.extract(), 'AAAAAAAAAAAAAAAAAAAAAAAAAAAA')
        # tip = t.extract()
        # print(tip)
            ...
            if just_province == '广西壮族自治区':
                ...
                if len(person_info) != 1:
                    ...
                    for p in person_info:
                        person_data = {'companyName': company_name, 'licenseNum': number, 'area': '广西壮族自治区', 'sex': '',
                                       'idCard': '', 'grade': '', 'major': '', 'num': '', 'regNum': '', 'validTime': '',
                        ...
                        print(valid_time.extract_first().split(), 'AAAAAAAAAAAAAAA')
